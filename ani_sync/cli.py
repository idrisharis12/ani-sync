...
def get_config_dir():
    ...
    try:
        ...
        logger.debug("Error in get_config_dir", exc_info=True)
    return p
...
def load_config():
    ...
    if CONFIG_PATH.exists():
        try:
            ...
            logger.debug("Failed to read file/json", exc_info=True)
...
def refresh_mal_token():
    ...
    try:
        ...
        logger.debug("Error in refresh_mal_token", exc_info=True)
    return None
